...
class YolosModule(torch.nn.Module):
    def __init__(self, model_name: str):
        ...
        self._model = transformers.AutoModelForObjectDetection.from_pretrained(
            model_name, revision="95a90f3c189fbfca3bcfc6d7315b9e84d95dc2de"
        )
...
def reference_inputs(
    ...
    processor = transformers.AutoImageProcessor.from_pretrained(model_name, revision="95a90f3c189fbfca3bcfc6d7315b9e84d95dc2de")
