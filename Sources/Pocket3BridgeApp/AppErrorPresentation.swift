...
enum AppErrorPresentation {
    ...
    static func key(forCode code: String, fallback: AppErrorMessageKey = .generic) -> AppErrorMessageKey {
        ...
        case "stop_unverified", "usb_stop_failed", "usb_stop_unverified", "usb_stop_feedback_stale", "native_neutral_failed", "zoom_stop_failed", "zoom_stop_unverified", "zoom_stop_feedback_stale", "zoom_stop_required": return .stopUnconfirmed
