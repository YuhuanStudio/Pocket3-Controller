...
extension AppModel {
    ...
    func handleNativeNetworkRouteValidation(_ request: ServiceRequest) throws -> ServiceReply {
        ...
        let configuration = try nativeNetworkConfiguration(from: fields)
...
func nativeNetworkConfiguration(from fields: [String: JSONValue]) throws -> Pocket3DatalinkSocketConfiguration {
    ...
    return Pocket3DatalinkSocketConfiguration(interfaceName: interfaceName,
        interfaceIndex: interfaceIndex, cameraHost: cameraHost)
}
