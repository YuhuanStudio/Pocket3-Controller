...
- [ ] H.264 host-output 4K30最新整合版效能：第20批有359個avc1 samples／359 decode、BGRA輸出與clean restore，但12秒warmup後median僅21.25fps（20.96–21.79），不可沿用舊29.11fps結果宣稱即時30fps。需以bounded async decode/backpressure診斷後重測。[結果](artifacts/hardware-complete-2026-09-12/capture-format-4k30-h264.json)
